/*
  ...
  1. Changes
    ...
    - Convert start_date to reservation_date
...
-- Enum for reservation plan types
...
ALTER TABLE reservations 
  ADD COLUMN plan_type reservation_plan DEFAULT 'day',
...
-- Add check constraint for valid reservation date
ALTER TABLE reservations
...
-- Add check constraint for custom time slots
ALTER TABLE reservations
